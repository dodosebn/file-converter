...
app.post('/upload', auth, upload.single('file'), async (req: AuthRequest, res: Response) => {
  try {
    const file = req.file;
...
app.get('/history', auth, async (req: AuthRequest, res: Response) => {
...
app.delete('/file/:id', auth, async (req: AuthRequest, res: Response) => {
  try {
